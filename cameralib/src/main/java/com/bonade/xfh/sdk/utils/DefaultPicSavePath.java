...
public class DefaultPicSavePath implements SavePath {
    ...
    public String getCropPicPath() {
        String cropPicPath="";
        if(saveOnce){
            cropPicPath= parentPath+"Android_WintoneIDCard_"+"0000002"+"thaicode.jpg";
        }else{
            cropPicPath= parentPath+"Android_WintoneIDCard_"+pictureName()+"thaicode.jpg";
        }
        return cropPicPath;
    }
    ...
    public String getFullPicPath() {
        String fullPicPath="";
        if(saveOnce){
            fullPicPath= parentPath+"Android_WintoneIDCard_"+"0000001"+"thaicode.jpg";
        }else{
            fullPicPath= parentPath+"Android_WintoneIDCard_"+pictureName()+"thaicode.jpg";
        }
    ...
    public String getHeadPicPath() {
        String headPicPath="";
        if(saveOnce){
            headPicPath= parentPath+"Android_WintoneIDCard_"+"0000003"+"thaicode.jpg";
        }else{
            headPicPath= parentPath+"Android_WintoneIDCard_"+pictureName()+"thaicode.jpg";
        }
