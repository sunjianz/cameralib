...
import com.bonade.xfh.sdk.utils.CardScreenUtil;
...
public abstract class OcrBaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public abstract void SerailNumberAuth(String authNumber);
    ...
    private String[][] intiList() {
        ...
        if (getResources().getConfiguration().locale.getLanguage().equals("zh")
            ...
            String[][] temp = {{"机读码", "3000"},
                    ...
                    {"厦门社会保障卡", "1039"},
                    {"福建社会保障卡", "1041"},
                    {"香港居民身份证2003版（照片页）", "1001", "1"},
                    {"香港居民身份证2018版（照片页）", "1001", "2"},
                    {"户口本", "16"},
                    {"港澳居民来往内地通行证(照片页)", "14"},
                    {"港澳居民来往内地通行证(机读码页)", "15"},
            ...
            String[][] temp = {{"機讀碼", "3000"},
                    ...
                    {"廈門社會保障卡", "1039"},
                    {"福建社會保障卡", "1041"},
                    {"香港居民身份證2003版（照片頁）", "1001", "1"},
                    {"香港居民身份證2018版（照片頁）", "1001", "2"},
                    {"戶口本", "16"},
                    {"港澳居民來往內地通行證(照片頁)", "14"},
                    {"港澳居民來往內地通行證(機讀碼頁)", "15"},
            ...
            String[][] temp = {{"Machine readable zone", "3000"},
                    ...
                    {"Xiamen Social Security Card", "1039"}, {"Fujian Social Security Card", "1041"}, {"HK ID card 2003 Edition", "1001", "1"}, {"HK ID card 2018 Edition", "1001", "2"}, {"Household Register", "16"},
